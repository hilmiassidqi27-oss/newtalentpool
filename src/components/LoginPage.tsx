...
export default function LoginPage({ onLoginSuccess }: LoginPageProps) {
  ...
  const AUTHORIZED_CREDENTIALS = [
    ...
    { username: 'hilmiassidqi27@gmail.com', password: 'password123', role: 'Super Admin', email: 'hilmiassidqi27@gmail.com', fullName: 'Hilmi Assidqi' },
    ...
    <div className="bg-surface-bright flex min-h-screen items-center justify-center p-4 md:p-0 relative overflow-hidden font-sans">
      ...
      <main className="relative z-10 w-full max-w-[480px]">
        ...
        <div className="bg-surface-container-lowest border border-table-border rounded-lg shadow-sm p-8 md:p-12">
          ...
          {/* Help Info Box */}
          <div className="mb-6 p-3 bg-secondary-container/30 border border-secondary-container/50 rounded text-xs text-primary flex flex-col gap-1.5">
            <div className="flex items-center gap-1.5 font-bold text-xs text-primary">
              <ShieldCheck className="w-4 h-4 text-primary shrink-0" />
              <span>Sistem Akses Terbatas (Restricted Access)</span>
            </div>
            <p className="text-[11px] text-on-surface-variant leading-relaxed">
              Hanya akun tertentu yang diizinkan masuk. Akun Google yang terdaftar: <strong className="text-primary font-bold">Hilmiassidqi27@gmail.com</strong>. Atau gunakan Username <strong className="text-primary font-bold">admin</strong> dengan Password <strong className="text-primary font-bold">password123</strong>.
            </p>
          </div>
