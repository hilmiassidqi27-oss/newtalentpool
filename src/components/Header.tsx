...
export default function Header({ user, searchQuery, onSearchChange, candidates, onLogout, onEditProfile }: HeaderProps) {
          ...
          {showProfileMenu && (
            <div className="absolute right-0 mt-2 w-48 bg-white border border-table-border rounded-lg shadow-lg z-50 py-1">
              ...
              <button
                ...
                className="w-full text-left px-4 py-2 text-xs text-on-surface hover:bg-surface-container-low transition-colors font-sans focus:outline-none cursor-pointer"
              >
