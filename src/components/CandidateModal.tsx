...
export default function CandidateModal({ 
  ...
  const [selectedPosition, setSelectedPosition] = useState(positionsList[0] || 'Scaffolder');
  ...
  useEffect(() => {
    if (candidateToEdit) {
      ...
      setName('');
      setSelectedPosition(positionsList[0] || 'Scaffolder');
      setCustomPosition('');
  ...
  }, [candidateToEdit, isOpen, positionsList]);
